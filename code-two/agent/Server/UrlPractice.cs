namespace SoftAgent.Server
{
    public class UrlPractice
    {
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/candles?instrument=" + instrument + "&count=" + count + "&candleFormat=" + candleFormat + "&granularity=" + granularity + "&dailyAlignment=" + dailyAlignment + "&alignmentTimezone=" + alignmentTimezone;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts";
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/positions/" + instrument;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/positions";
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/transactions?instrument=" + instrument + "&count=" + count;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/transactions/" + transactionId;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/trades?instrument=" + instrument;
        }
        /// <summary>
        /// Returns the open trades.
        /// </summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/trades?instrument=" + instrument + "&count=" + count;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/trades/" + tradeId;
        }
        /// <summary>
        /// Returns the orders.
        /// </summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/orders?instrument=" + instrument + "&count=" + count;
        }
        /// <summary>
        ...
        {
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accountId + "/orders/" + orderId;
        }
        /// <summary>
        ...
        public static string PlaceMarketOrder(int accoundId, string instrument, int units, string side)
        {
            ...
            return "https://api-fxpractice.oanda.com/v1/accounts/" + accoundId + "/orders"; //instrument=" + instrument + "&units=" + units + "&side=" + side + "&type=" + type;
        }
        /// <summary>
        /// Places an order.
        /// </summary>
