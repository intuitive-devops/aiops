...
namespace Boagaphish
{
    ...
    public static class Logging
    {
        ...
        /// </summary>
        public enum LogCaller { Accounts, AgentCore, AgentGui, AgentVoice, AlgorithmicComputation, Automat, DeepLearning, Genome, Orders, OrderInformation, Positions, Rates, Statistics, Tasks, Trades, Transactions, TrendGui }
        /// <summary>
