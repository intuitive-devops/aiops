...
{
    public class OpenIndex : IComparable<OpenIndex>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenIndex"/> class.
        /// </summary>
        /// <param name="amount">The amount of the index.</param>
        /// <param name="date">The date of the index.</param>
        public OpenIndex(double amount, DateTime date)
        {
            Amount = amount;
            Date = date;
        }
        ...
        /// </summary>
        /// <param name="other">The other open index.</param>
        /// <returns>Date comparison result.</returns>
        public int CompareTo(OpenIndex other)
        {
